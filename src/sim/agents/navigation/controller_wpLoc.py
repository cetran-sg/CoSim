...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, wpLoc):
        """
        ...
        current_steering = self._lat_controller.run_step(wpLoc)
...
class PIDLateralController():
    ...
    def run_step(self, wpLoc):
        ...
        """
        return self._pid_control(wpLoc, self._vehicle.get_transform())

    def _pid_control(self, wpLoc, vehicle_transform):
        """
